...
[execution.cargo]
inherit = ["PATH", "HOME", "TMPDIR", "LANG", "CARGO_HOME", "RUSTUP_HOME", "RUSTUP_TOOLCHAIN"]
...
reject = ["CARGO_*", "RUST*", "LD_PRELOAD", "DYLD_*"]
"#;
...
impl Fixture {
    fn new() -> Self {
        ...
        let home = support::depot(&[("rules/workflow.toml", WORKFLOW)]);
