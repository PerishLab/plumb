...
fn beta(remote: plumb::forge::Remote, caller: String, dry: bool) -> Result<String, String> {
...
fn stable(remote: plumb::forge::Remote, input: Promotion) -> Result<String, String> {
